    ...
    <>
      <div className="w-[80%] md:w-[60%] h-[450px] md:h-[470px]  rounded-md shadow-lg flex flex-col space-y-3 items-center border-2 border-blue-200 ">
        ...
        <div className="w-[80%] h-[60px] ">
          <h2 className="text-sm text-blue-700">Name</h2>
          <input
            value={signUpData.name}
            onChange={(e) => dispatch({ type: "name", name: e.target.value })}
            type="text"
            className="w-full  pl-4 h-[40px] border-2 rounded-sm border-blue-400 outline-none"
            name=""
            id=""
          />
        </div>
        <div className="w-[80%] h-[60px] ">
          <h2 className="text-sm text-blue-700">Mobile</h2>
          <input
        ...
        <div className="w-[80%] h-[100px]  flex flex-col justify-center">
          <button
            className=" hover:bg-blue-700  w-[100%] h-[50px] bg-blue-500 text-xl cursor-pointer text-white rounded-md font-semibold"
